import TemplateFormrow from './formrow.html';
import TemplateRaw from './raw.html';
import TemplateDescriptionlist from './descriptionlist.html';

export default Vue => {

    Vue.component('bixie-fields', {
        extends: Vue.component('fields'),
        template: TemplateFormrow,
        fields: {
    ...
    Vue.component('bixie-fields-list', {
        extends: Vue.component('bixie-fields'),
        template: TemplateDescriptionlist,
    });
